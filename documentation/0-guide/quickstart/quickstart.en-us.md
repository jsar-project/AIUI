...
#### **4.1 Method 1: After closing the message, upload the AIUI project directly to bind it**

![image.png](../../image/quickstart.en-us/image%204.png)

#### **4.2 Method 2: Go to Editor Settings > Local Management, then bind the corresponding AIUI Agent**
