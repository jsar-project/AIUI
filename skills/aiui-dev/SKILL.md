...
- If behavior on a physical device differs from Craft, report the inconsistency as a bug instead of changing this Skill to prescribe an application-level workaround.
